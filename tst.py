...
print(encode("SAM SAM").decode(encoding))
print(encode("supercalifragilisticexpialidocious supercalifragilisticexpialidocious").decode(encoding))
print(encode("LZSS will take over the world!").decode(encoding))
print(encode("It even works with 😀s thanks to UTF-8").decode(encoding))